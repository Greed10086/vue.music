<template>
    <div class="container" style="width: 90%">
        ...
        <h5 id="vocal-range-title" style="font-family: 'STKaiti', sans-serif;"> 确定最高音高 </h5>

        <p style="font-family: 'Roboto', sans-serif; margin-left: 30px;">
            从 C4 开始直到 C6,将会听到每个音符的声音。
            单击开始之后，尝试用“啊”或“呣”一起唱歌，并尽可能将检测到的音符与播放的音符匹配。<br><br>
        ...
        <button style="display:none; margin-left: 30px;" id="stop"
            class="waves-effect waves-light btn-flat btn-large indigo lighten-5">停止</button>
        <button style="margin-left: 30px;" class="waves-effect waves-light btn-flat btn-large indigo lighten-5"
            id="practice">开始</button>

        <p style="margin-left: 30px;">最高音符：<span id="currentNote"></span> </p>
        <p style="margin-left: 30px; display: none;">当前得分：<span id="currentScore"></span> </p>
        ...
        <div>
            ...
            <RouterLink to="/vocal_range/results"><button id="next-button" style="margin-left: 30px; display: none;"
