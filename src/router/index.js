...
const routes = [
    ...
    { path: '/video', name: 'video', component: () => import('../components/video.vue'), meta: { keepAlive: false } },
    { path: '/video1', name: 'video1', component: () => import('../components/video1.vue'), meta: { keepAlive: false } },
    { path: '/video2', name: 'video2', component: () => import('../components/video2.vue'), meta: { keepAlive: false } },
    { path: '/lessons', component: () => import('../components/lessons.vue'),meta: { keepAlive: false } },
